    ...
    return (
        <div className="bg-[#FDF8F3] min-h-screen pt-32 pb-48 relative overflow-hidden">
            ...
            <header className="mb-48 relative z-10">
                <Container>
                    <div className="max-w-5xl">
                        ...
                        >
                            <span className="text-brand-yellow font-bold uppercase tracking-[0.5em] text-xs mb-8 block">Scientific Excellence Exchange</span>
                            <h1 className="text-5xl ss:text-7xl md:text-9xl font-display text-brand-green uppercase leading-none tracking-tighter mb-12">
                                Engineered <br />
                                <span className="text-brand-green/20 italic">Reliability </span>
                            </h1>
                            <p className="text-xl ss:text-2xl md:text-3xl text-brand-green/70 font-medium leading-tight max-w-2xl">
                ...
                <Container>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        <div className="space-y-12">
                            <h2 className="text-4xl ss:text-5xl md:text-6xl font-display text-brand-green uppercase leading-none">
                                The heart of <br /> all extracts
                            </h2>
                ...
                <Container>
                    <div className="mb-24 flex items-end justify-between">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-4xl ss:text-6xl font-display text-brand-green uppercase leading-none">The Processing <br /> Workflow</h2>
                        </div>
            ...
            <section className="mt-64 relative z-10">
                <Container>
                    <div className="bg-brand-green rounded-[4rem] p-8 ss:p-16 md:p-32 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-12">
                            <h3 className="text-4xl ss:text-5xl md:text-7xl font-display text-white uppercase leading-none tracking-tighter">
...
function WorkflowStep({ step, index }: WorkflowStepProps) {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className={`group relative grid grid-cols-1 lg:grid-cols-12 gap-12 p-6 ss:p-10 md:p-16 rounded-[4rem] border transition-all duration-700 overflow-hidden ${isFeatured
        ...
        >
            {/* Background Number */}
            <div className={`absolute top-0 right-0 text-[10rem] ss:text-[18rem] md:text-[25rem] font-display leading-[0.7] transition-opacity duration-1000 select-none ${isFeatured ? 'opacity-[0.03] text-white' : 'opacity-[0.02] text-brand-green'
                }`}>
                0{step.id}
            </div>
            ...
            <div className="lg:col-span-6 space-y-8 z-10">
                <div className="space-y-4">
                    ...
                    <h3 className="text-3xl ss:text-4xl md:text-5xl font-display uppercase leading-[0.9] tracking-tighter">
                        {step.title}
                    </h3>
                </div>
                ...
                <div className={`p-6 ss:p-8 rounded-[2rem] border ${isFeatured ? 'bg-white/5 border-white/10' : 'bg-brand-peach/5 border-brand-green/5'
                    }`}>
