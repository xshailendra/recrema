...
export function HeroSection() {
    return (
        <section className="relative min-h-screen flex flex-col overflow-hidden">
            ...
            <motion.div
                className="absolute top-24 lg:top-32 left-0 right-0 z-30 flex justify-center gap-6 lg:gap-12 px-6 lg:px-4 whitespace-nowrap overflow-x-auto scrollbar-hide"
            ...
            >
                {hashtags.map((tag) => (
                    <motion.span
                        key={tag}
                        className="text-white font-bold text-sm lg:text-base tracking-tight cursor-default"
            ...
            <motion.h1
                className="no-transition absolute top-[35%] lg:top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center text-[18vw] lg:text-[16rem] font-display leading-[1.1] uppercase tracking-tighter z-10 pointer-events-none select-none whitespace-nowrap py-4"
                style={{
            ...
            <Container className="relative z-30 mt-auto pb-12 lg:pb-10">
                ...
                >
                    <div className=" flex flex-col items-start max-w-lg">
                        ...
                        >
                            <p className="text-white font-bold text-base lg:text-lg leading-relaxed">
                                Recrema transforms coffee waste into high-value eco-ingredients for cosmetics, pharmaceuticals, agriculture, and functional foods.
                            </p>
                            <p className="text-white font-bold text-base lg:text-lg leading-relaxed">
                                Our mission: Nothing goes to waste. Every by-product becomes an opportunity for innovation, sustainability, and profitability.
                            </p>
                        </motion.div>
